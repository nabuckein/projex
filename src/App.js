...
class App extends Component {
  ...
  toProjects=(e)=>{    
    ...
    /*db.collection('projects').get().then((snapshot)=>{
      //projectsInFirebase = doc.data();
      snapshot.forEach((doc)=>{
        projectsInFirebase.push(doc.data());
        
      })
      //NEED THIS setState BELOW TO BE INSIDE THIS FUNCTION TO WORK, OTHERWISE IT ONLY WORKS THE FIRST TIME A PROJECT IS ADDED
      this.setState({componentToDisplay:"Projects", projects: projectsInFirebase});
    });*/
